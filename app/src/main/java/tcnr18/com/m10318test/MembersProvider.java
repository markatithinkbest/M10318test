...
public class MembersProvider extends ContentProvider {
	...
	static final String PROVIDER_NAME = "tcnr18.com.m10318test.MembersProvider";

	static final String SUB1 = "sub1";
	static final String URL = "content://" + PROVIDER_NAME + "/" + SUB1;
	...
	static final String DATABASE_NAME = "final.db"; // YOUR DESIRED DATABASE
	static final String TABLE_NAME = "members"; // YOUR DESIRED TABLE
	static final int DATABASE_VERSION = 2; // ### need to increase when change
											// table structure
